...
template<> VREXPANSIONPLUGIN_API UScriptStruct* StaticStruct<FGripComponentEndPhysicsTickFunction>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGripMotionControllerComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UGripMotionControllerComponent_GetGripMass, "GetGripMass" }, // 2437034639
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripMotionControllerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGripMotionControllerComponent, UGripMotionControllerComponent::StaticClass, TEXT("UGripMotionControllerComponent"), &Z_Registration_Info_UClass_UGripMotionControllerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGripMotionControllerComponent), 2387633706U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripMotionControllerComponent_h_3701711994(TEXT("/Script/VRExpansionPlugin"),
