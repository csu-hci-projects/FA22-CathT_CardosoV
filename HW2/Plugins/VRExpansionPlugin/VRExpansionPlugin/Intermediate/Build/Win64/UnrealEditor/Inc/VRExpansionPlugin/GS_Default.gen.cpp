...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_bLimitGripScaling = { "bLimitGripScaling", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UGS_ExtendedDefault), &Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_bLimitGripScaling_SetBit, METADATA_PARAMS(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_bLimitGripScaling_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_bLimitGripScaling_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MinimumGripScaling = { "MinimumGripScaling", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGS_ExtendedDefault, MinimumGripScaling), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MinimumGripScaling_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MinimumGripScaling_MetaData)) }; // 3121577039
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MaximumGripScaling = { "MaximumGripScaling", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGS_ExtendedDefault, MaximumGripScaling), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MaximumGripScaling_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGS_ExtendedDefault_Statics::NewProp_MaximumGripScaling_MetaData)) }; // 3121577039
	...
	struct Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Default_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Default_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGS_Default, UGS_Default::StaticClass, TEXT("UGS_Default"), &Z_Registration_Info_UClass_UGS_Default, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGS_Default), 2588944695U) },
		{ Z_Construct_UClass_UGS_ExtendedDefault, UGS_ExtendedDefault::StaticClass, TEXT("UGS_ExtendedDefault"), &Z_Registration_Info_UClass_UGS_ExtendedDefault, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGS_ExtendedDefault), 3864737995U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Default_h_890630895(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Default_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_GripScripts_GS_Default_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
