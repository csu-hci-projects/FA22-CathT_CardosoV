...
template<> OPENVREXPANSIONPLUGIN_API UScriptStruct* StaticStruct<FBPOpenVRCameraHandle>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenVRExpansionFunctionLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UOpenVRExpansionFunctionLibrary_GetOpenVRHMDType, "GetOpenVRHMDType" }, // 3206071390
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_OpenVRExpansionPlugin_Source_OpenVRExpansionPlugin_Public_OpenVRExpansionFunctionLibrary_h_Statics::EnumInfo[] = {
		...
		{ EBPOpenVRHMDDeviceType_StaticEnum, TEXT("EBPOpenVRHMDDeviceType"), &Z_Registration_Info_UEnum_EBPOpenVRHMDDeviceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3865945507U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_OpenVRExpansionPlugin_Source_OpenVRExpansionPlugin_Public_OpenVRExpansionFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenVRExpansionFunctionLibrary, UOpenVRExpansionFunctionLibrary::StaticClass, TEXT("UOpenVRExpansionFunctionLibrary"), &Z_Registration_Info_UClass_UOpenVRExpansionFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenVRExpansionFunctionLibrary), 119984798U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginExpProject_Plugins_VRExpansionPlugin_OpenVRExpansionPlugin_Source_OpenVRExpansionPlugin_Public_OpenVRExpansionFunctionLibrary_h_3588643945(TEXT("/Script/OpenVRExpansionPlugin"),
